...
> A local-first agent harness on the Claude Agent SDK (model routing, security guardrails, adversarial evals) with every non-trivial decision recorded: 32 ADRs, a threat model mapped to the OWASP Agentic Top 10, and a red-team gate on every PR.
